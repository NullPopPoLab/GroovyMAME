...
#define CORE_INPUT_TYPES_P1 \
		...
		INPUT_PORT_DIGITAL_TYPE(  1, PLAYER1,  START,               N_p("input-name", "%p Start"),               input_seq(JOYCODE_START_INDEXED(0)) ) \
		INPUT_PORT_DIGITAL_TYPE(  1, PLAYER1,  SELECT,              N_p("input-name", "%p Coin"),                input_seq(JOYCODE_SELECT_INDEXED(0)) ) \
...
#define CORE_INPUT_TYPES_P2 \
		...
		INPUT_PORT_DIGITAL_TYPE(  2, PLAYER2,  START,               N_p("input-name", "%p Start"),               input_seq(JOYCODE_START_INDEXED(1)) ) \
		INPUT_PORT_DIGITAL_TYPE(  2, PLAYER2,  SELECT,              N_p("input-name", "%p Coin"),                input_seq(JOYCODE_SELECT_INDEXED(1)) ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_P3 \
		...
		INPUT_PORT_DIGITAL_TYPE(  3, PLAYER3,  SELECT,              N_p("input-name", "%p Coin"),                input_seq(JOYCODE_SELECT_INDEXED(2)) ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_P4 \
		...
		INPUT_PORT_DIGITAL_TYPE(  4, PLAYER4,  SELECT,              N_p("input-name", "%p Coin"),                input_seq(JOYCODE_SELECT_INDEXED(3)) ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_P5 \
		...
		INPUT_PORT_DIGITAL_TYPE(  5, PLAYER5,  SELECT,              N_p("input-name", "%p Coin"),                input_seq(JOYCODE_SELECT_INDEXED(4)) ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_P6 \
		...
		INPUT_PORT_DIGITAL_TYPE(  6, PLAYER6,  SELECT,              N_p("input-name", "%p Coin"),                input_seq(JOYCODE_SELECT_INDEXED(5)) ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_P7 \
		...
		INPUT_PORT_DIGITAL_TYPE(  7, PLAYER7,  SELECT,              N_p("input-name", "%p Coin"),                input_seq(JOYCODE_SELECT_INDEXED(6)) ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_P8 \
		...
		INPUT_PORT_DIGITAL_TYPE(  8, PLAYER8,  SELECT,              N_p("input-name", "%p Coin"),                input_seq(JOYCODE_SELECT_INDEXED(7)) ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_P9 \
		...
		INPUT_PORT_DIGITAL_TYPE(  9, PLAYER9,  SELECT,              N_p("input-name", "%p Coin"),                input_seq(JOYCODE_SELECT_INDEXED(8)) ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_P10 \
		...
		INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, SELECT,              N_p("input-name", "%p Coin"),                input_seq(JOYCODE_SELECT_INDEXED(9)) ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_START \
		CORE_INPUT_TYPES_BEGIN(start) \
		INPUT_PORT_DIGITAL_TYPE(  0, OTHER,    START1,              N_p("input-name", "1 Player Start"),         input_seq(JOYCODE_START_INDEXED(0)) ) \
		INPUT_PORT_DIGITAL_TYPE(  0, OTHER,    START2,              N_p("input-name", "2 Players Start"),        input_seq(JOYCODE_START_INDEXED(1)) ) \
...
#define CORE_INPUT_TYPES_PEDAL \
		...
		INPUT_PORT_ANALOG_TYPE(   1, PLAYER1,  PEDAL,               N_p("input-name", "%p Pedal 1"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON8_INDEXED(0)) ) \
		INPUT_PORT_ANALOG_TYPE(   2, PLAYER2,  PEDAL,               N_p("input-name", "%p Pedal 1"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON8_INDEXED(1)) ) \
		INPUT_PORT_ANALOG_TYPE(   3, PLAYER3,  PEDAL,               N_p("input-name", "%p Pedal 1"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON8_INDEXED(2)) ) \
		INPUT_PORT_ANALOG_TYPE(   4, PLAYER4,  PEDAL,               N_p("input-name", "%p Pedal 1"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON8_INDEXED(3)) ) \
		INPUT_PORT_ANALOG_TYPE(   5, PLAYER5,  PEDAL,               N_p("input-name", "%p Pedal 1"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON8_INDEXED(4)) ) \
		INPUT_PORT_ANALOG_TYPE(   6, PLAYER6,  PEDAL,               N_p("input-name", "%p Pedal 1"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON8_INDEXED(5)) ) \
		INPUT_PORT_ANALOG_TYPE(   7, PLAYER7,  PEDAL,               N_p("input-name", "%p Pedal 1"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON8_INDEXED(6)) ) \
		INPUT_PORT_ANALOG_TYPE(   8, PLAYER8,  PEDAL,               N_p("input-name", "%p Pedal 1"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON8_INDEXED(7)) ) \
		INPUT_PORT_ANALOG_TYPE(   9, PLAYER9,  PEDAL,               N_p("input-name", "%p Pedal 1"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON8_INDEXED(8)) ) \
		INPUT_PORT_ANALOG_TYPE(  10, PLAYER10, PEDAL,               N_p("input-name", "%p Pedal 1"),            input_seq(), input_seq(), input_seq(JOYCODE_BUTTON8_INDEXED(9)) ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_PEDAL2 \
		CORE_INPUT_TYPES_BEGIN(pedal2) \
		INPUT_PORT_ANALOG_TYPE(   1, PLAYER1,  PEDAL2,              N_p("input-name", "%p Pedal 2"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON7_INDEXED(0)) ) \
		INPUT_PORT_ANALOG_TYPE(   2, PLAYER2,  PEDAL2,              N_p("input-name", "%p Pedal 2"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON7_INDEXED(1)) ) \
		INPUT_PORT_ANALOG_TYPE(   3, PLAYER3,  PEDAL2,              N_p("input-name", "%p Pedal 2"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON7_INDEXED(2)) ) \
		INPUT_PORT_ANALOG_TYPE(   4, PLAYER4,  PEDAL2,              N_p("input-name", "%p Pedal 2"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON7_INDEXED(3)) ) \
		INPUT_PORT_ANALOG_TYPE(   5, PLAYER5,  PEDAL2,              N_p("input-name", "%p Pedal 2"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON7_INDEXED(4)) ) \
		INPUT_PORT_ANALOG_TYPE(   6, PLAYER6,  PEDAL2,              N_p("input-name", "%p Pedal 2"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON7_INDEXED(5)) ) \
		INPUT_PORT_ANALOG_TYPE(   7, PLAYER7,  PEDAL2,              N_p("input-name", "%p Pedal 2"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON7_INDEXED(6)) ) \
		INPUT_PORT_ANALOG_TYPE(   8, PLAYER8,  PEDAL2,              N_p("input-name", "%p Pedal 2"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON7_INDEXED(7)) ) \
		INPUT_PORT_ANALOG_TYPE(   9, PLAYER9,  PEDAL2,              N_p("input-name", "%p Pedal 2"),             input_seq(), input_seq(), input_seq(JOYCODE_BUTTON7_INDEXED(8)) ) \
		INPUT_PORT_ANALOG_TYPE(  10, PLAYER10, PEDAL2,              N_p("input-name", "%p Pedal 2"),            input_seq(), input_seq(), input_seq(JOYCODE_BUTTON7_INDEXED(9)) ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_UI \
		...
		INPUT_PORT_DIGITAL_TYPE( 0, UI,       UI_CONFIGURE,         N_p("input-name", "Config Menu"),            input_seq(KEYCODE_TAB, input_seq::or_code, JOYCODE_MENU_INDEXED(0)) ) \
		...
		INPUT_PORT_DIGITAL_TYPE( 0, UI,       UI_UP,                N_p("input-name", "UI Up"),                  input_seq(KEYCODE_UP, input_seq::or_code, JOYCODE_Y_UP_SWITCH_INDEXED(0), input_seq::or_code, JOYCODE_Y_HAT1UP_INDEXED(0)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,       UI_DOWN,              N_p("input-name", "UI Down"),                input_seq(KEYCODE_DOWN, input_seq::or_code, JOYCODE_Y_DOWN_SWITCH_INDEXED(0), input_seq::or_code, JOYCODE_Y_HAT1DOWN_INDEXED(0)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,       UI_LEFT,              N_p("input-name", "UI Left"),                input_seq(KEYCODE_LEFT, input_seq::or_code, JOYCODE_X_LEFT_SWITCH_INDEXED(0), input_seq::or_code, JOYCODE_X_HAT1LEFT_INDEXED(0)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,       UI_RIGHT,             N_p("input-name", "UI Right"),               input_seq(KEYCODE_RIGHT, input_seq::or_code, JOYCODE_X_RIGHT_SWITCH_INDEXED(0), input_seq::or_code, JOYCODE_X_HAT1RIGHT_INDEXED(0)) ) \
		...
		INPUT_PORT_DIGITAL_TYPE( 0, UI,       UI_SELECT,            N_p("input-name", "UI Select"),              input_seq(KEYCODE_ENTER, input_seq::not_code, KEYCODE_LALT, input_seq::not_code, KEYCODE_RALT, input_seq::or_code, JOYCODE_BUTTON2_INDEXED(0), input_seq::or_code, KEYCODE_ENTER_PAD) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,       UI_CANCEL,            N_p("input-name", "UI Cancel"),              input_seq(KEYCODE_BACKSPACE, input_seq::or_code, JOYCODE_CANCEL_INDEXED(0)) ) \
		...
		INPUT_PORT_DIGITAL_TYPE( 0, UI,       UI_CLEAR,             N_p("input-name", "UI Clear"),               input_seq(KEYCODE_DEL, input_seq::or_code, JOYCODE_CLEAR_INDEXED(0)) ) \
