...
constexpr input_code JOYCODE_MENUBTN_INDEXED(int n)  { return input_code(DEVICE_CLASS_JOYSTICK, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_MENUBTN); }
constexpr input_code JOYCODE_CLEARBTN_INDEXED(int n) { return input_code(DEVICE_CLASS_JOYSTICK, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_CLEARBTN); }
constexpr input_code JOYCODE_BACKBTN_INDEXED(int n)  { return input_code(DEVICE_CLASS_JOYSTICK, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_BACKBTN); }
constexpr input_code JOYCODE_OPTBTN_INDEXED(int n)   { return input_code(DEVICE_CLASS_JOYSTICK, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_OPTBTN); }
...
#define JOYCODE_MENUBTN JOYCODE_MENUBTN_INDEXED(0)
#define JOYCODE_CLEARBTN JOYCODE_CLEARBTN_INDEXED(0)
#define JOYCODE_BACKBTN JOYCODE_BACKBTN_INDEXED(0)
#define JOYCODE_OPTBTN JOYCODE_OPTBTN_INDEXED(0)
